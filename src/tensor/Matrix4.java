...
public class Matrix4 {
	 ...
	 * @param topCoordinate
	 *            for the bottom horizontal clipping pane
	 * @param near
	 *            Coordinate for the near depth clipping pane
	 * @param farCoordinate
	 *            for the far depth clipping pane
	 *
	 ...
	 * @param farCoordinate
	 *            for the far depth clipping pane, must be positive
	 *
	 ...
	 *            positive
	 * @param farDistance
	 *            from the viewer to the far clipping plane, must be positive
	 *
	 * @return Perspective matrix
	 */
