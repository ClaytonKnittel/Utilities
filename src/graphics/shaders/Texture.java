 ...
 * GL_CLAMP_TO_BORDER Gives coordinates outside range a specific border color
 * 
 */
public class Texture {
	...
	/**
	 * 
	 * @param modeX GL_REPEAT, GL_MIRRORED_REPEAT, GL_CLAMP_TO_EDGE, or GL_CLAMP_TO_BORDER
	 * @param modeY GL_REPEAT, GL_MIRRORED_REPEAT, GL_CLAMP_TO_EDGE, or GL_CLAMP_TO_BORDER
	 */
	...
	/**
	 * @param GL_REPEAT, GL_MIRRORED_REPEAT, GL_CLAMP_TO_EDGE, or GL_CLAMP_TO_BORDER
	 */
	...
	/**
	 * @param mode GL_NEAREST, GL_LINEAR, etc.
	 */
