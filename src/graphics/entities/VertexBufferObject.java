...
public class VertexBufferObject {
     ...
     * target is usually <code>GL_ARRAY_BUFFER</code>.
     *
     * @param target Target to upload
     * @param data   Buffer with the data to upload
     * @param usage  GL_STATIC_DRAW usually
     */
     ...
     * target in the tutorial should be <code>GL_ARRAY_BUFFER</code>
     *
     * @param target Target to upload
     * @param size   Size in bytes of the VBO data store
     * @param usage  Usage of the data (likely GL_DYNAMICL_DRAW)
     */
